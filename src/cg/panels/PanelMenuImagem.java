...
/**
 * Painel com as configurações necessárias para aplicação de transformações em uma Imagem.
 *
    ...
    private void carregarImagem(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carregarImagem
        try {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                imagem = Imagem.carregaImagem(file.getSelectedFile());
                imagem.setPonto2D(0, 0); //posicao inicial
                PlanoCartesiano.getInstance().drawImage(imagem);
            }
